...
<html>
    ...
    <body>
        <%//construindo e enviando request ao endpoint e gerando um JSON Array a partir da response
            ...
            wt = client.target(uri).path("instituicoes/doar");
            Invocation.Builder builder = wt.request(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, "Bearer " + "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJqb3NlcGVkcm8xMjMiLCJpc3MiOiJteV9hcHAiLCJpYXQiOjE2NTg3NzIxNjd9.0c_2MfskNuF4YGgT_4pFZQM9S0mjDZh5ggflXCbBThI");
        ...
        <jsp:include page="menu.jsp"/>      
        <div class="container mt-4 mb-4">
            <h1 class="text-center mb-4 pb-5">Doe seu pet para as melhores instituições!</h1>
        ...
        %>
                <div class="col">
                    <div class="card h-100 border-success shadow">
                        ...
                        <!-- criando botão "Doar Pets" -->
                        <div class="card-footer text-center">
                            <a href="getPetsInstituicao.jsp?id=<%out.println(obj.getInt("id"));%>" class="btn btn-success">Doar Pets</a>
                        </div>  
                    </div>
                </div>
        <% } %> 
